...
const Contact = () => {
  ...
  return (
    ...
    <div className="w-full">
      ...
      <div className="p-6 w-full flex flex-col md:flex-row justify-between gap-4 md:gap-10 lgl:gap-20">
        <div className="w-full lgl:w-1/2">
          ...
          <p className="flex justify-between w-full text-lg text-[#ccc] py-4 border-b-[1px] border-b-zinc-800">
            ...
            <a href="tel:+91-9044753765"  rel="noreferrer" className="cursor-pointer hover:firstClr">
              +91-9044753765
            </a>
          </p>
        </div>
        <div className="w-full lgl:w-1/2">
          <p className="flex justify-between lgl:gap-6 w-full text-lg text-[#ccc] py-4 border-b-[1px] border-b-zinc-800">
            ...
            <a href="mailto:khushbusingh7348@gmail.com"  rel="noreferrer" className="cursor-pointer hover:firstClr">
      ...
      {/* <div className="w-full mt-10 d-none">
        <Title title="Send" subTitle="Messages" />
        {successMsg ? (
          <p className="text-center text-sm font-titleFont p-20 secClr">
            {successMsg}
          </p>
        ) : (
          <form
