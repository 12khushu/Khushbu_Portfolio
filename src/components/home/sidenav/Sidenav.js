...
const Sidenav = () => {
  return (
    <div className="px-7 py-4">
      ...
      <SidenavTitle title="Contact" subTitle=" Me" />
      <ul>
        <li className="sidenavLi secClr cursor-pointer hover:firstClr"> <a href="tel:+91-9044753765"  rel="noreferrer" className="cursor-pointer hover:firstClr">
              +91-9044753765
          </a></li>
        <li className="sidenavLi secClr cursor-pointer hover:firstClr"><a href="mailto:khushbusingh7348@gmail.com"  rel="noreferrer" className="cursor-pointer hover:firstClr">
              khushbusingh7348@gmail.com
            </a></li>
      </ul>
    </div>
  );
